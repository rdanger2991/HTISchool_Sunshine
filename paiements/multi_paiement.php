        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                                ...
                                <form name="add_name" method="post">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-control-border" name="code_eleve" value="<?php echo $_GET['code_eleve']; ?>" placeholder="entrer le code" readonly>
                  ...
                  WHERE inscription.code_eleve =:code");
                        $result2->bindParam(':code', $code_eleve);
                        $result2->execute();
                        ?>
                        <div class="col-6">
                            <?php
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                               ...
                               inscription.classe_id, info_paiement.code_paiement as code_paiement, info_paiement.montant_verse, info_paiement.balance, info_paiement.date_paiement
                ...
                <a rel="facebox" href="valider_paiement.php?id_trx=<?php echo $_GET['id'] ?>&trx_number=<?php echo $_GET['trx_number'] ?>&id_insc=<?php echo $id_insc ?>&montant_verser=<?php echo $montant_verse ?>&balance=<?php echo $balance ?>&id_mod_paie=<?php echo $id_mod_paie ?>&date_paiement=<?php echo $date_paiement ?>&code_eleve=<?php echo $code_eleve ?>">
                    <center><button class="btn btn-info"><i class="icon icon-save icon-large"></i> VALIDER</button></center>
                </a>
                <br>
