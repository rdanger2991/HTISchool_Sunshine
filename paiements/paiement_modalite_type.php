        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Gestion des des categories de paiement</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../index.php">ACCUEIL</a></li>
                                <li class="breadcrumb-item active">Gestion des categories de paiement</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $result = $bdd->prepare("SELECT * FROM paiement_modalite_type ORDER BY id_type_paiement ASC");
                                            $result->execute();
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalEdit<?php echo $row['id_type_paiement']; ?>">Modifier</button></td>


                                                </tr>
                                                <!-- modal edit-->
                                                <div class="modal fade" id="modalEdit<?php echo $row['id_type_paiement']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="Save_edit_type_paiement.php" method="post">

                                                                <div class="modal-body">

                                                                    <div class="form-group">
                                                                        <label for="name">CATEGORIE</label>
                                                                        <input type="text" class="form-control" name="categorie_type" value="<?php echo $row['categorie_type']; ?>">
                                                                    </div>

                                                                </div>

                                                                <div class="modal-footer">
                                                                    <input type="hidden" name="id_type_paiement" value="<?php echo $row['id_type_paiement']; ?>" />
                    ...
                    <div class="form-group">
                        <form name="add_name" id="add_name">
                            <table class="table table-bordered table-hover" id="dynamic_field">
                                <tr>
                                    <td><input type="text" name="categorie_type[]" onkeyup="this.value=this.value.toUpperCase()" placeholder="ENTER" class="form-control name_email" /></td>
