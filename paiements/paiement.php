...
<?php
//Genere code automatique
include('../connexion/conn.php');
$result = $bdd->prepare("SELECT COUNT(code_paiement) AS code FROM info_paiement");
$result->execute();
$row = $result->fetch();
//$t= substr($c,0 ,3);
//$a=$t.""."1000".$row['code'];

$a = "SUNACAPAIE-" . "1000" . $row['code'];
?>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="col-md-2">
                        <a href="new_paiement.php?id=cash&trx_number=<?php echo $a ?>" class="btn btn-primary btn-block mb-3">NOUVEAU PAIEMENT</a>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            include('../connexion/conn.php');
                                            $result = $bdd->prepare("SELECT * FROM paiement ORDER BY id_paie ASC");
                                            $result->execute();
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['']; ?></td>
                                                    <td><?php echo $row['']; ?></td>
                                                    <td><button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#modalEdit<?php echo $row['id_paie']; ?>">Modifier</button></td>


                                                </tr>
                                                <!-- modal edit-->
                                                <div class="modal fade" id="modalEdit<?php echo $row['id_paie']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            ...
                                                            <form action="saveEditClasse.php" method="post">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="code_classe" value="<?php echo $row['']; ?>" readonly>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="name_classe" value="<?php echo $row['']; ?>">
                                                                    </div>

                                                                </div>

                                                                <div class="modal-footer">
                                                                    <input type="hidden" name="id" value="<?php echo $row['id_paie']; ?>" />
